        ...
        <CardContent className="pt-6">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-1.5 mb-1">
              ...
              <h1 className="text-2xl font-bold text-primary bg-gradient-to-r from-purple-500 to-indigo-600 bg-clip-text text-transparent pb-1 matrix-font">NIKU MODS</h1>
            </div>
            <p className="text-muted-foreground text-sm mt-1">Professional License Management</p>
          </div>
